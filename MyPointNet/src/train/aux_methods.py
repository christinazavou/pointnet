...
Usually when we train or test we use a specific batch size of input data. We need to calculate the statistics of the training data and use those in the test data as well. Normally you want to have training data with similar statistics to the test data, otherwise your NN won't perform well.
